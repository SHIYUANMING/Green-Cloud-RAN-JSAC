...
%w1=params.w1(Active_index);  %length(Active_index)x1: weigth for each group beamformer
w=params.w(Active_index);
...
minimize (w'*t)  % group sparsity inducing minimization
subject to
